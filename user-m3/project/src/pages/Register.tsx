...
import { validateEmail, validatePhone, validatePassword, validateConfirmPassword, validateFullName } from '../utils/validation';
        ...
        >
          ...
          <div className="text-center">
            <span className="text-sm text-gray-600">
              ...
              <Link to="/login" className="font-medium text-[#053DA6] hover:underline">
                Sign in here
              </Link>
            </span>
          </div>
