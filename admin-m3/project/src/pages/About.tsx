  ...
  const values = [
    {
      ...
      description: 'We believe in complete transparency with all investment information, legal documentation, and blockchain verification.'
    },
    {
      icon: Users,
      title: 'Democratization',
      description: 'Making real estate investment accessible to every Nigerian, regardless of their financial background.'
    },
    {
      icon: Heart,
      title: 'Community Impact',
      description: 'Contributing to solving Nigeria\'s housing deficit while creating wealth for our investors.'
    },
    {
      icon: Award,
      title: 'Excellence',
      description: 'Delivering exceptional service and maintaining the highest standards in everything we do.'
    }
  ];
  ...
  const milestones = [
    {
      ...
      description: 'M3 Shelter was established with a vision to democratize real estate investment in Nigeria.'
    },
    {
      year: '2022',
      title: 'SEC Registration',
      description: 'Obtained regulatory approval from the Securities and Exchange Commission, Nigeria.'
    },
    {
      year: '2023',
      title: 'First Property Launch',
      description: 'Successfully funded our first property in Lekki, Lagos with over 200 investors.'
    },
    {
      year: '2024',
      title: 'Platform Expansion',
      description: 'Launched mobile app and expanded to Abuja and Port Harcourt markets.'
    },
    {
      year: '2025',
      title: 'Growth Milestone',
      description: '5,000+ active investors and ₦2.5B+ in properties under management.'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              We're on a mission to democratize real estate investment in Nigeria, making property ownership 
              accessible to every Nigerian while contributing to solving the housing deficit.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                To democratize real estate investment in Nigeria by leveraging blockchain technology and 
                fractional ownership, enabling every Nigerian to build wealth through property investment 
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                To become Africa's leading real estate investment platform, transforming how people invest 
                in property across the continent while fostering economic growth and financial inclusion.
              </p>
              <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-secondary-600">50,000+</div>
                    <div className="text-gray-600 text-sm">Active Investors</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-secondary-600">₦50B+</div>
                    <div className="text-gray-600 text-sm">Properties Funded</div>
                  </div>
                  <div className="text-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">Building a track record of success and trust</p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">The experts behind M3 Shelter's success</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-xl text-primary-100">
                Have questions about investing with M3 Shelter? We'd love to hear from you.
              </p>
