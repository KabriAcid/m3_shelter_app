  ...
  const properties = [
    {
      ...
      description:
        "Modern apartment complex in the heart of Lekki Phase 1, featuring luxury amenities and high rental demand.",
      riskLevel: "Low",
    ...
    },
    {
      ...
      description:
        "New residential estate development in Gwarinpa with modern infrastructure and family-friendly amenities.",
      riskLevel: "Medium",
    ...
    },
    {
      ...
      description:
        "Prime commercial property in Port Harcourt's business district with high foot traffic and established tenants.",
      riskLevel: "Low",
    ...
    },
    {
      ...
      description:
        "Premium office complex in Victoria Island targeting multinational companies and tech startups.",
      riskLevel: "Medium",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Discover carefully vetted real estate investment opportunities
              across Nigeria. Start building your portfolio with fractional
              ownership from ₦50,000.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100">
              Join thousands of investors building wealth through Nigerian real
              estate. Download the app and start with as little as ₦50,000.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-lg font-semibold text-gray-900">
                    {selectedProperty.minInvestment} min
                  </div>
                </div>
