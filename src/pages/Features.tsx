  ...
  const mainFeatures = [
    {
      ...
      description:
        "All transactions and ownership records are secured on the blockchain for complete transparency and immutability.",
      color: "primary",
      benefits: [
    ...
    },
    {
      ...
      title: "Legal Vault",
      description:
        "Access all property documents, deeds, surveys, and legal papers through our secure digital vault.",
      color: "secondary",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Monitor your investment performance, property values, and rental income with comprehensive analytics.",
      color: "green",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Multiple payment options with bank-level security including local Nigerian payment gateways.",
      color: "blue",
      benefits: [
  ...
  const appFeatures = [
    {
      ...
      description:
        "Comprehensive mobile app to manage all your investments on the go.",
    },
    {
      icon: Bell,
      title: "Smart Notifications",
      description:
        "Real-time updates on payouts, new opportunities, and market changes.",
    },
    {
      icon: BarChart3,
      title: "Investment Tracking",
      description:
        "Detailed analytics and performance metrics for all your properties.",
    },
    {
      icon: Users,
      title: "Community Features",
      description:
        "Connect with other investors and share investment strategies.",
    },
    {
      icon: MapPin,
      title: "Property Location",
      description:
        "Interactive maps and location details for all investment properties.",
    },
    {
      icon: Globe,
      title: "Market Insights",
      description:
        "Access to real estate market data and investment opportunities.",
    },
  ];
  ...
  const securityFeatures = [
    {
      ...
      description:
        "All data is encrypted using 256-bit SSL encryption, the same standard used by banks.",
    },
    {
      title: "Two-Factor Authentication",
      description:
        "Additional security layer to protect your account from unauthorized access.",
    },
    {
      title: "Regulatory Compliance",
      description:
        "Fully compliant with SEC Nigeria regulations and data protection laws.",
    },
    {
      title: "Automated Backups",
      description:
        "Your data is automatically backed up across multiple secure servers.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Discover the powerful features that make M3 Concepts the most
              secure and user-friendly real estate investment platform in
              Nigeria.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built with cutting-edge technology to provide the most secure and
              transparent real estate investment experience.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to manage your real estate investments, right
              in your pocket.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                ...
                ensuring your peace of mind and the safety of your funds.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connected to Nigeria's leading financial institutions and payment
              providers for a smooth experience.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              {
                name: "Nigerian Banks",
                desc: "Direct integration with all major banks",
              },
              {
                name: "Payment Gateways",
                desc: "Paystack, Flutterwave, and more",
              },
              {
                name: "Mobile Money",
                desc: "Support for all mobile payment platforms",
              },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Access all property documents instantly through our
                blockchain-secured Legal Vault. Complete transparency at your
                fingertips.
              </p>
              <div className="space-y-4">
                {[
                  {
                    ...
                    desc: "Original and certified true copies",
                  },
                  {
                    icon: MapPin,
                    title: "Survey Plans",
                    desc: "CAD files and boundary surveys",
                  },
                  {
                    icon: CheckCircle,
                    title: "Legal Clearance",
                    desc: "Due diligence reports and clearances",
                  },
                  {
                    icon: Clock,
                    title: "Version History",
                    desc: "Complete document timeline and updates",
                  },
                ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100">
              Download the M3 Concepts app and explore all these powerful
              features designed to make real estate investment simple, secure,
              and profitable.
            </p>
