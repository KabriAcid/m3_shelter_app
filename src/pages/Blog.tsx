...
const Blog = () => {
  ...
  const featuredPost = {
    ...
    excerpt:
      "Everything you need to know about investing in Nigerian real estate, from market analysis to choosing the right properties for maximum returns.",
  ...
  const blogPosts = [
    {
      id: 2,
      title:
        "Lagos Property Market Analysis Q4 2024: What Investors Need to Know",
      excerpt:
        "A comprehensive analysis of the Lagos property market performance in Q4 2024, including price trends, demand patterns, and investment opportunities.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to calculate and understand rental yields, the key metric every real estate investor should know to make informed investment decisions.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "A detailed comparison of investment opportunities in Nigeria's two major cities, analyzing factors like growth potential, rental yields, and market stability.",
    ...
    },
    {
      ...
      excerpt:
        "Explore the psychological aspects of real estate investment and learn strategies to overcome common fears and biases that can impact investment decisions.",
      image: "https://images.pexels.com/photos/280222/pexels-photo-280222.jpeg",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100">
              ...
              investment insights, market analysis, and success stories
