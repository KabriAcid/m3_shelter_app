    ...
    <div className="min-h-screen bg-[#F7F7F2] p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-[#261C15] mb-2">Account Settings</h1>
          ...
          >
            ...
            {activeTab === 'profile' && (
              <Card className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-[#261C15]">Profile Information</h2>
                ...
                <form onSubmit={handleProfileSubmit} className="space-y-6">
                  <FormInput
                    ...
                    onChange={(e) => profileForm.setFieldValue('fullName', e.target.value)}
                  ...
                  <FormInput
                    ...
                    onChange={(e) => profileForm.setFieldValue('email', e.target.value)}
                  ...
                  <FormInput
                    ...
                    onChange={(e) => profileForm.setFieldValue('phone', e.target.value)}
            ...
            {activeTab === 'security' && (
              <div className="space-y-6">
                <Card className="p-6">
                  <h2 className="text-2xl font-bold text-[#261C15] mb-4">Change Password</h2>
                  <form onSubmit={handlePasswordSubmit} className="space-y-6">
                    <div className="relative">
                      <FormInput
                        ...
                        onChange={(e) => passwordForm.setFieldValue('currentPassword', e.target.value)}
                ...
                <Card className="p-6">
                  <h3 className="text-xl font-bold text-[#261C15] mb-4">Two-Factor Authentication</h3>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-[#261C15]">SMS Authentication</p>
            ...
            {activeTab === 'notifications' && (
              <Card className="p-6">
                <h2 className="text-2xl font-bold text-[#261C15] mb-6">Notification Preferences</h2>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-[#261C15]">Email Notifications</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-[#261C15]">SMS Notifications</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-[#261C15]">Investment Updates</p>
            ...
            {activeTab === 'billing' && (
              <Card className="p-6">
                <h2 className="text-2xl font-bold text-[#261C15] mb-6">Billing Information</h2>
                <p className="text-gray-600 mb-4">Manage your payment methods and billing history</p>
            ...
            {activeTab === 'documents' && (
              <Card className="p-6">
                <h2 className="text-2xl font-bold text-[#261C15] mb-6">Identity Documents</h2>
                <p className="text-gray-600 mb-4">Upload and manage your verification documents</p>
                <div className="space-y-4">
