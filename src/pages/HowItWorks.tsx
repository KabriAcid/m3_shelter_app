  ...
  const models = [
    {
      ...
      description:
        "Invest in income-generating properties alongside other investors and earn regular rental income.",
      color: "primary",
      features: [
    ...
    },
    {
      ...
      description:
        "Pool funds with other investors to construct new properties from scratch and share the profits.",
      color: "secondary",
      features: [
  ...
  const investmentProcess = [
    {
      ...
      description:
        "Get the M3 Concepts app and create your account with BVN verification for security.",
    },
    {
      icon: Building2,
      title: "Explore Properties",
      description:
        "Browse curated properties with detailed information, location, and projected returns.",
    },
    {
      icon: DollarSign,
      title: "Make Investment",
      description:
        "Choose your investment amount and purchase fractional shares through secure payment.",
    },
    {
      icon: FileText,
      title: "Access Legal Vault",
      description:
        "Get instant access to all property documents and legal papers through blockchain security.",
    },
    {
      icon: TrendingUp,
      title: "Earn Returns",
      description:
        "Receive regular rental income and track your investment performance in real-time.",
    },
  ];
    ...
    <div className="pt-20">
      ...
      <section className="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl font-bold">How M3 Concepts Works</h1>
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Two innovative investment models designed to make real estate
              ownership accessible to every Nigerian, starting from as little as
              ₦50,000.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From download to earning returns, here's your complete journey
              with M3 Concepts
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Every investment is backed by blockchain technology and
                regulatory compliance to ensure maximum security and
                ...
                {[
                  {
                    ...
                    description:
                      "All transactions and ownership records are immutably stored on the blockchain.",
                  },
                  {
                    title: "Legal Documentation",
                    description:
                      "Complete access to property deeds, surveys, and legal papers through our Legal Vault.",
                  },
                  {
                    title: "Regulatory Compliance",
                    description:
                      "Fully regulated by the Securities and Exchange Commission, Nigeria.",
                  },
                  {
                    title: "Real-time Tracking",
                    description:
                      "Monitor your investments, returns, and property performance 24/7.",
                  },
                ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100">
              ...
              Start with as little as ₦50,000.
            </p>
